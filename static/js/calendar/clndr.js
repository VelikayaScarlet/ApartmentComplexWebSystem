...
;(function ( $, window, document, undefined ) {
  ...
  // This is the default calendar templates. This can be overridden.
  ...
  function Clndr( element, options ) {
    ...
    // templates compiling, making and storing some elements we'll need later,
  ...
  Clndr.prototype.init = function () {
    ...
    // do a normal render of the calendar templates
    this.render();
