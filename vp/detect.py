...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp/weights/besty.pt',
                        help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / r'C:\\Users\\79433\\Desktop\\pic\\',
